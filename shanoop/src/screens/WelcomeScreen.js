...
const Pagination = ({index}) =>{
  return(
    <View style={styles.pageContainer}>
      ...
      index?(<View style={pageStyle(true)} key={i}/>):
...
const WelcomeScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Separator height={Display.setHeight(8)} />
      {welcomeListIndex===2 ?(<TouchableOpacity
      ...
      <View style={styles.buttonContainer} >
        <TouchableOpacity activeOpacity={0.8} style={styles.skipButton} onPress={()=> welcomeList.current.scrollToEnd()} >
