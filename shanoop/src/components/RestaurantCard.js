...
const RestaurantCard = ({id,name,images:{poster},tags,distance,time,navigate}) => {
  return (
    <TouchableOpacity style={styles.container} activeOpacity={0.8} onPress={()=>navigate(id)} >
      <Ionicons name="bookmark" color={Colors.DEFAULT_YELLOW} size={24} style={styles.bookmark}/>
      <Image source={{uri: StaticImageService.getPoster(poster)}} style={styles.posterStyle}/>
